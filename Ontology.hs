...
getWindSpeed r = applyToDataPointField r DS.currently DS.windSpeed (GWindSpeedVal . GFloat)

getWindSpeedType r = applyToDataPointField r DS.currently DS.windBearing op
